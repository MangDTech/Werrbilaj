    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to Api MangDTech - an awesome REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6285658019360">WhatsApp</a></span></span>
            <span style="display: block;"><br>Regards,<br>MangDTech</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"MangDTech" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - Api MangDTech`,
        html: inboxGmail,
      };
